...
import TableRow from '../components/AlbumComponents/TableRow';
import CreateAlbumForm from '../components/AlbumComponents/CreateAlbumForm';
import UpdateAlbumForm from '../components/AlbumComponents/UpdateAlbumForm';
...
function Albums({ backendURL }) {
    ...
    return (
        <>
            ...
            <UpdateAlbumForm albums={albums} genres={genres} backendURL={backendURL} refreshAlbums={getData} />
        </>
    );
